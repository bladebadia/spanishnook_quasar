<template>
  <div class="legal-page q-pa-lg text-center">
    <p class="text-h3 text-blue text-bold">POLÍTICA DE PRIVACIDAD DEL SITIO WEB</p>
    <p class="text-h5 text-blue text-bold q-mt-md">I. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS</p>
    <p class="text-h6 text-left">
      Respetando lo establecido en la legislación vigente, (en adelante, también Sitio Web) se compromete a
      adoptar las medidas técnicas y organizativas necesarias, según el nivel de seguridad adecuado al riesgo
      de los datos recogidos. <br />  
      Leyes que incorpora esta política de privacidad.  Esta política de privacidad está adaptada a 
      la normativa española y europea vigente en materia de
      protección de datos personales en internet. En concreto, la misma respeta las siguientes normas:
    </p>
    <p style="text-indent: 2em;" class="text-h6 q-mt-md  text-left">
      &#8226 El Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo<br />
     ...
     <br />
      &#8226 La Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los
      derechos digitales (LOPD-GDD).
     <br />
      &#8226 El Real Decreto 1720/2007, de 21 de diciembre, por el que se aprueba el Reglamento de desarrollo
      de la Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal
      (RDLOPD).
     <br />
      &#8226 La Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio
      Electrónico (LSSI-CE).
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      Identidad del responsable del tratamiento de los datos personales
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      El responsable del tratamiento de los datos personales recogidos en es: , con NIF: (en adelante,
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">      
      ...
      recabados por , mediante los formularios extendidos en sus páginas quedarán incorporados y serán
      tratados en nuestro fichero con el fin de poder facilitar, agilizar y cumplir los compromisos establecidos
      entre y el Usuario o el mantenimiento de la relación que se establezca en los formularios que este rellene,
      o para atender una solicitud o consulta del mismo. Asimismo, de conformidad con lo previsto en el RGPD y
      la LOPD-GDD, salvo que sea de aplicación la excepción prevista en el artículo 30.5 del RGPD, se mantiene
      un registro de actividades de tratamiento que especifica, según sus finalidades, las actividades de
      tratamiento llevadas a cabo y las demás circunstancias establecidas en el RGPD.
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      Las categorías de datos que se tratan en son únicamente datos identificativos. En ningún caso, se tratan
      categorías especiales de datos personales en el sentido del artículo 9 del RGPD.
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      Base legal para el tratamiento de los datos personales
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      La base legal para el tratamiento de los datos personales es el consentimiento. se compromete a recabar
      el consentimiento expreso y verificable del Usuario para el tratamiento de sus datos personales para uno o
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      Los datos personales son recabados y gestionados por con la finalidad de poder facilitar, agilizar y cumplir
      los compromisos establecidos entre el Sitio Web y el Usuario o el mantenimiento de la relación que se
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      ...
      estadística, y actividades propias del objeto social de , así como para la extracción, almacenamiento de
      datos y estudios de marketing para adecuar el Contenido ofertado al Usuario, así como mejorar la calidad,
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      ...
      tratamiento y, en todo caso, únicamente durante el siguiente plazo: , o hasta que el Usuario solicite su
      supresión.
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      ...
      podrán otorgar su consentimiento para el tratamiento de sus datos personales de forma lícita por . Si se
      trata de un menor de 14 años, será necesario el consentimiento de los padres o tutores para el
      tratamiento, y este solo se considerará lícito en la medida en la que los mismos lo hayan autorizado.
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      ...
      personal y se evite la destrucción, pérdida o alteración accidental o ilícita de datos personales
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      Sin embargo, debido a que no puede garantizar la inexpugnabilidad de internet ni la ausencia total de
      hackers u otros que accedan de modo fraudulento a los datos personales, el Responsable del tratamiento
      se compromete a comunicar al Usuario sin dilación indebida cuando ocurra una violación de la seguridad
      de los datos personales que sea probable que entrañe un alto riesgo para los derechos y libertades de las
      personas físicas. Siguiendo lo establecido en el artículo 4 del RGPD, se entiende por violación de la
      seguridad de los datos personales toda violación de la seguridad que ocasione la destrucción, pérdida o
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      El Usuario tiene sobre y podrá, por tanto, ejercer frente al Responsable del tratamiento los siguientes
      derechos reconocidos en el RGPD y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos
      Personales y garantía de los derechos digitales:
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      Derecho de acceso: Es el derecho del Usuario a obtener confirmación de si está tratando o no sus
      datos personales y, en caso afirmativo, obtener información sobre sus datos concretos de carácter
      personal y del tratamiento que haya realizado o realice, así como, entre otra, de la información
      disponible sobre el origen de dichos datos y los destinatarios de las comunicaciones realizadas o
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      ...
      de carácter personal o se cese el tratamiento de los mismos por parte de .
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      ...
      del tratamiento con la referencia \"RGPD-\", especificando:
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      ...
      distintos de , y que por tanto no son operados por . Los titulares de dichos sitios web dispondrán de sus
    ...
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      se reserva el derecho a modificar su Política de Privacidad, de acuerdo a su propio criterio, o motivado por
      un cambio legislativo, jurisprudencial o doctrinal de la Agencia Española de Protección de Datos. Los
      cambios o actualizaciones de esta Política de Privacidad no serán notificados de forma explícita al Usuario.
    </p>
    <p class="text-h6 q-mt-md q-mb-xl text-left">
      Se recomienda al Usuario consultar esta página de forma periódica para estar al tanto de los últimos
      ...
      de política de privacidad web gratis online el día 02/09/2025.
    </p>
  </div>
</template>
